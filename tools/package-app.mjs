...
const [appPath] = await packager({
  ...
  arch: 'x64',
  overwrite: true,
  // The mark on the executable, and therefore in the task bar and on every
  // shortcut Windows makes from it. Generated by tools/make-icon.mjs.
  icon: path.join(ROOT, 'desktop', 'build', 'icon'),
  asar: {
